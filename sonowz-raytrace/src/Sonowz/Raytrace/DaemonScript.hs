...
raytraceScript _id config raytracePath outputPath =
  do
    cd raytracePath
  ...
  `catch` \(_ :: SomeException) -> return (ShellResult (ExitFailure 1) "" "Unexpected error")

example :: IO ()
example = void $ raytraceScript 1 exampleConfig "/home/sonowz/packages/raytrace" "/home/sonowz/data/www/graphics-demo/image/raytrace" where
  exampleConfig = ""
